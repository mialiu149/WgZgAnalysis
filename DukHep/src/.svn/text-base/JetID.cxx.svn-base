/**
  ...
  Usage:
  bool isbad_medium = JetID::isBadJet(JetID::MediumBad,emf,HECf,LArQ,HECq,time,SumPtTrk,eta,pt,fmax,negE);
  bool isbad_loose  = JetID::isBadJet(JetID:: LooseBad,emf,HECf,LArQ,HECq,time,SumPtTrk,eta,pt,fmax,negE);
**/
