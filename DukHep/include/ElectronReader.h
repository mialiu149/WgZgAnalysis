...
class ElectronReader {
  public:
    ...
    void InitElectronLHTool(Root::TElectronLikelihoodTool*); 
    //define your getters hereegRescaler::EnergyRescalerUpgrade*
    ...
    int ElectronLH(unsigned int il,int);
    double deltaPoverP(int);
    float GetElectronTransverseMomentum(unsigned int il,float&);
    TLorentzVector FillElectronFourMomentum(unsigned int il);
    TLorentzVector FillElectronCluster(unsigned int il);
    ...
    std::vector<int> ElectronObjID(unsigned int il,float ptmin,std::vector<int>&);
    bool IsGoodElectronEWKW(unsigned int il, float ptmin,std::vector<int>&,bool);  
    bool IsGoodElectronEWK(unsigned int il, float ptmin,int IDtype,bool);  
    bool IsGoodElectronEWKZ(unsigned int il, float ptmin,bool);  
  ...
  public:
    ...
    Root::TElectronLikelihoodTool* elht;
    ...
    std::vector<int>* m_ElectronNPixelDeadSensors;
    std::vector<int>* m_ElectronNSCTDeadSensors;
    ...
    std::vector<float>* m_ElectrondeltaphiRescaled;
