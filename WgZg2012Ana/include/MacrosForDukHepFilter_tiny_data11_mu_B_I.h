////DukHep/bin/dukhep_create_filter.py DukHep/hzgskim_tiny_data11_mu_B_I.txt
...
#define DECLARE( stringTREENAME )                      \
  {    DeclareVariable( o_m_RunNumber, "RunNumber" );	\
    ...
    DeclareVariable( o_m_EF_e20_medium, "EF_e20_medium" );	\
...
#define COPYVAR                      \
  {   o_m_RunNumber = m_RunNumber;\
   ...
   o_m_EF_e20_medium = m_EF_e20_medium;\
