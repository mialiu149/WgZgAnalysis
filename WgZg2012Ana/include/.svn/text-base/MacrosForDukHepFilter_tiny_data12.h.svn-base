////DukHep/bin/dukhep_create_filter.py DukHep/hzgskim_tiny_data12.txt
...
Bool_t m_EF_2e23Tvh_loose1;	\
Bool_t o_m_EF_2e23Tvh_loose1;	\
...
#define CONNECT( stringTREENAME )                      \
  {    ConnectVariable( (stringTREENAME), "RunNumber", m_RunNumber );	\
    ...
    ConnectVariable( (stringTREENAME), "EF_2e23Tvh_loose1", m_EF_2e23Tvh_loose1 );	\
...
#define DECLARE( stringTREENAME )                      \
  {    DeclareVariable( o_m_RunNumber, "RunNumber" );	\
    ...
    DeclareVariable( o_m_EF_2e23Tvh_loose1, "EF_2e23Tvh_loose1" );	\
...
#define COPYVAR                      \
  {   o_m_RunNumber = m_RunNumber;\
   ...
   o_m_EF_2e23Tvh_loose1 = m_EF_2e23Tvh_loose1;\
