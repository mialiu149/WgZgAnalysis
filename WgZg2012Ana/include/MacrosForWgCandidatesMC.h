...
Float_t o_m_Etalgg;\
Float_t o_m_Etagg;\
std::vector<float> o_m_TightLeptons_cl_E;   \
std::vector<float> o_m_MediumLeptons_cl_E;  \
std::vector<float> o_m_GoodPhotons_cl_E;    \
std::vector<float> o_m_TightLeptons_cl_Pt;  \
std::vector<float> o_m_MediumLeptons_cl_Pt; \
std::vector<float> o_m_GoodPhotons_cl_Pt;   \
std::vector<float> o_m_TightLeptons_cl_Eta; \
std::vector<float> o_m_MediumLeptons_cl_Eta;\
std::vector<float> o_m_GoodPhotons_cl_Eta;  \
std::vector<float> o_m_TightLeptons_cl_Phi; \
std::vector<float> o_m_MediumLeptons_cl_Phi;\
std::vector<float> o_m_GoodPhotons_cl_Phi;  \
...
std::vector<int> o_m_GoodPhotonsPDGID;\
std::vector<int> o_m_GoodPhotonsMother;\
...
#define DECLARE_WG( stringTREENAME )                      \
  { DeclareVariable( o_m_METx, "METx" );	\
    ...
    DeclareVariable( o_m_TightLeptons_cl_E,"tightlep_cl_E" );	\
    DeclareVariable( o_m_MediumLeptons_cl_E,"mediumlep_cl_E" );	\
    DeclareVariable( o_m_GoodPhotons_cl_E,"ph_cl_E" );	\
    DeclareVariable( o_m_TightLeptons_cl_Pt,"tightlep_cl_Pt" );	\
    DeclareVariable( o_m_MediumLeptons_cl_Pt,"mediumlep_cl_Pt" );	\
    DeclareVariable( o_m_GoodPhotons_cl_Pt,"ph_cl_Pt" );	\
    DeclareVariable( o_m_TightLeptons_cl_Eta,"tightlep_cl_Eta" );	\
    DeclareVariable( o_m_MediumLeptons_cl_Eta,"mediumlep_cl_Eta" );	\
    DeclareVariable( o_m_GoodPhotons_cl_Eta,"ph_cl_Eta" );	\
    DeclareVariable( o_m_TightLeptons_cl_Phi,"tightlep_cl_Phi" );	\
    DeclareVariable( o_m_MediumLeptons_cl_Phi,"mediumlep_cl_Phi" );	\
    DeclareVariable( o_m_GoodPhotons_cl_Phi,"ph_cl_Phi" );	\
    ...
    DeclareVariable( o_m_GoodPhotonsPDGID,"ph_pdgId" );	\
    DeclareVariable( o_m_GoodPhotonsMother,"ph_mother" );	\
...
#define RESETVAR_WG                      \
  { o_m_METx= -999;\
    ...
    o_m_Etalg.clear();\
    o_m_dRlg.clear();\
    o_m_TightLeptons_cl_E.clear();\
    o_m_TightLeptons_cl_Pt.clear();\
    o_m_TightLeptons_cl_Eta.clear();\
    o_m_TightLeptons_cl_Phi.clear();\
    o_m_MediumLeptons_cl_E.clear();\
    o_m_MediumLeptons_cl_Pt.clear();\
    o_m_MediumLeptons_cl_Eta.clear();\
    o_m_MediumLeptons_cl_Phi.clear();\
    o_m_GoodPhotons_cl_E.clear();\
    o_m_GoodPhotons_cl_Pt.clear();\
    o_m_GoodPhotons_cl_Phi.clear();\
    o_m_GoodPhotons_cl_Eta.clear();\
    ...
    o_m_GoodPhotonsPDGID.clear();\
    o_m_GoodPhotonsMother.clear();\
